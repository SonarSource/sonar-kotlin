...
fun configureAnalysisApiServices(env: KotlinCoreEnvironment) {
    // FIXME we need FE - see
    // https://cs.android.com/android-studio/platform/tools/base/+/abd625a51312c08580b4fedfded82cd0c0f6c1d6:lint/cli/src/main/java/com/android/tools/lint/Fe10UastEnvironment.kt;bpv=0
    ...
    project.registerService(
        ...
        Hack.buildKtModuleProviderByCompilerConfiguration(
