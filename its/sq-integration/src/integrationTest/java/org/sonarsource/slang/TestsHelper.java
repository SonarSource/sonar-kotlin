...
public class TestsHelper {
  ...
  static {
    ...
    ORCHESTRATOR = orchestratorBuilder
            ...
            .restoreProfileAtStartup(FileLocation.of("src/integrationTest/resources/suppress-warnings-kotlin.xml"))
            .restoreProfileAtStartup(FileLocation.of("src/integrationTest/resources/norule.xml"))
