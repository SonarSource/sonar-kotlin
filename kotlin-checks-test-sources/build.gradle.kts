...
dependencies {
    ...
    implementation("org.jetbrains.kotlin:kotlin-reflect:2.4.20-neptune-251")
    implementation("org.jetbrains.kotlin:kotlin-test:2.4.20-neptune-251")
    implementation("org.jetbrains.kotlin:kotlin-test-junit5:2.4.20-neptune-251")
