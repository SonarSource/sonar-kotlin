...
// same package
import checks.DelicateCoroutinesApi // WHY? previously was Noncompliant {{Remove this redundant import.}}
// unused
import com.google.common.collect.ImmutableList // previously was Noncompliant {{Remove this unused import.}}
// unused
import com.google.common.collect.ImmutableList.copyOf // previously was Noncompliant {{Remove this unused import.}}
import com.google.common.collect.ImmutableList.of
import com.google.common.collect.ImmutableSet.of as immutable_set_of
// unused
import com.google.common.io.Files // previously was Noncompliant {{Remove this unused import.}}
...
import kotlin.Any // previously Noncompliant {{Remove this redundant import.}}
import okhttp3.TlsVersion.TLS_1_1
// unused
import okhttp3.TlsVersion.TLS_1_2 // previously Noncompliant {{Remove this unused import.}}
...
import okhttp3.TlsVersion.SSL_3_0 as TLS3 // previously Noncompliant {{Remove this unused import.}}
...
import operators.plusAssign // WHY? previously Noncompliant
import operators.minusAssign // WHY? previously Noncompliant
import operators.timesAssign // WHY? previously Noncompliant
import operators.divAssign // WHY? previously Noncompliant
import operators.remAssign // WHY? previously Noncompliant
