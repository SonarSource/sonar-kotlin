...
// same package/file
import checks.ClassInSameFile // Noncompliant {{Remove redundant import.}}
// same package
...
class UnnecessaryImportsCheckSample {
    ...
    lateinit var b : ClassInSameFile
...
class ChildClass1: java.util.Date()
class ChildClass2: Timer()
