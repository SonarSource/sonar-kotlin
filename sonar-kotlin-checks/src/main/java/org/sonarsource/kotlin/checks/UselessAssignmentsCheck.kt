...
//                    FirErrors.VARIABLE_WITH_REDUNDANT_INITIALIZER.name ->
                        diagnostic.psi to "Remove this useless initializer."

                    FirErrors.VARIABLE_NEVER_READ.name ->
//                    FirErrors.ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE.name ->
...
//                    FirErrors.UNUSED_VALUE.name ->
//                        diagnostic.psi to "The value assigned here is never used."

//                    FirErrors.UNUSED_CHANGED_VALUE.name ->
