...
internal class DetektSensorTest {
    ...
    companion object {
        private val PROJECT_DIR = Paths.get("src", "test", "resources", "org/sonarsource/kotlin/externalreport", "detekt")
    }
    ...
    fun issues_with_sonarqube() {
        ...
        assertThat(fourth.ruleKey().rule()).isEqualTo("Unknown-Or-Custom-Rule")
